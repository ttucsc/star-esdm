function [outTbl] = QC_to_netcdf_hourly_daily_1hr(varNames, stnInfo, yrRange, varargin)
% Program to convert csv or txt data to netcdf files.
%   This is a modified version of QC_to_netcdf_hourly_daily.m
%   THIS VERSION SHIFTS TIME BY 1 HOUR to correct mepdg' hcd files, which are off by 1 hour!
...
%           Parms.outVarNames(iv)="relativehumidity";
